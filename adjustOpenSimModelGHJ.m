...
% Read old and Write new to table and .xlsx
% old_table = readtable( '..\..\OpenSim\In\Models\RTSA_Adjusted\RTSA_model_log.xlsx');
% 
...
%     'cup_radius'};
% 
% xlsx_table = splitvars(table(string(date_time_now),...
%     string(rhash),...
%     GHJ_in_parent,...
%     GHJ_in_child, ...
...
% 
% new_xlsx_table = [old_table; xlsx_table];
% 
% writetable(new_xlsx_table, '..\..\OpenSim\In\Models\RTSA_Adjusted\RTSA_model_log.xlsx');
