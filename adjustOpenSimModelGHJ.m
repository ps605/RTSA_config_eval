function new_model_file = adjustOpenSimModelGHJ(GHJ_in_parent, GHJ_in_parent_rot, GHJ_in_child, hemi_gle_offsets, hemi_cup_offsets, R, rhash, model_SSM, flag_useTorque, flag_keepRC, flag_ReplaceMuscles)
